function [d, K, T2ML, phi, z, SumEch, log10K, log10T2, log10Porosity, SumEch_3s, SumEch_twm, SumEch_twm_3s] = loadnmrdata2(name)
    ...
    if strcmp(name, 'A1') ==0 && strcmp(name, 'C1') == 0 && strcmp(name, 'gems_all') ==0 && strcmp(name, 'all_data') == 0
        in=([pwd filesep 'bstrp_dat_VC_processed' filesep name '.txt']);               %define the datafile name
    ...
    elseif strcmp(name, 'A1') ==1 
        ...
        str2 = [pwd  filesep 'bstrp_dat_VC_processed' filesep 'dpnmrA11.txt']; 
        d2 = load(str2);
        SumEch_3s1 = d2(:,6); 
        SumEch_twm1 = d2(:,7); 
        SumEch_twm_3s1 = d2(:,8); 
        str3 = [pwd  filesep 'bstrp_dat_VC_processed' filesep 'dpnmrA12.txt'];
        d3 = load(str3);
    ...
    elseif strcmp(name, 'C1') == 1
        ...
        SumEch = 10.^SOE; 
        d = [z, T2ML, phi, K, SumEch];
        str2 = [pwd  filesep 'bstrp_dat_VC_processed' filesep 'dpnmrC1S.txt']; 
        d2 = load(str2);
        SumEch_3s1 = d2(:,6); 
        SumEch_twm1 = d2(:,7); 
        SumEch_twm_3s1 = d2(:,8); 
        str2 = [pwd  filesep 'bstrp_dat_VC_processed' filesep 'dpnmrC1SW.txt']; 
        d2 = load(str2);
        SumEch_3s2 = d2(:,6); 
        SumEch_twm2 = d2(:,7); 
        SumEch_twm_3s2 = d2(:,8);
        str3 = [pwd  filesep 'bstrp_dat_VC_processed' filesep 'dpnmrC1SE.txt'];
        d3 = load(str3);
